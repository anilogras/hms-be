...
namespace HMS.API_COMMON.Controllers.RoomDefinitions
{
    ...
    public class RoomLocationController : BaseController<RoomLocation, RoomLocationDTO>
    {
        public RoomLocationController(IGenericCQRS<RoomLocation, RoomLocationDTO> service) : base(service)
        {
        }
    }
}
