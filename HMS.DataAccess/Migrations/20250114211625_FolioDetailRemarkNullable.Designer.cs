...
namespace HMS.DataAccess.Migrations
{
    ...
    [Migration("20250114211625_FolioDetailRemarkNullable")]
    partial class FolioDetailRemarkNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HMS.Entities.Models.CommonModels.CompanyDefaultDepartments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("companydefaultdepartments");
                });

            modelBuilder.Entity("HMS.Entities.Models.CommonModels.CompanyDepartmentPeriod", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("companydepartmentperiod");
                });

            modelBuilder.Entity("HMS.Entities.Models.CommonModels.CompanyDepartments", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("HMS.Entities.Models.CommonModels.CompanyParemeters", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("HMS.Entities.Models.Definition.FrontOffice.Rate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("HMS.Entities.Models.Definition.FrontOffice.TaxSequence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PrecedingTax");

                    b.HasIndex("TaxId");

                    b.ToTable("taxsequence");
                });
            ...
            modelBuilder.Entity("HMS.Entities.Models.Definition.FrontOffice.TaxSequence", b =>
                {
                    b.HasOne("HMS.Entities.Models.Definition.FrontOffice.Tax", "PrecedingTaxes")
                        .WithMany("PrecedingTaxes")
                        .HasForeignKey("PrecedingTax")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HMS.Entities.Models.Definition.FrontOffice.Tax", "Tax")
                        .WithMany("TaxSequences")
                        .HasForeignKey("TaxId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PrecedingTaxes");
