...
namespace HMS.API_FRONTOFFICE.Controllers.SalesAndMarketing
{
    ...
    public class OutOfRoomLocationController : BaseController<OutOfRoomLocation, OutOfRoomLocationDTO>
    {
        public OutOfRoomLocationController(IGenericCQRS<OutOfRoomLocation, OutOfRoomLocationDTO> service) : base(service)
        {
        }
    }
}
