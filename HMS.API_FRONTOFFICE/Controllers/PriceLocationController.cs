...
namespace HMS.API_FRONTOFFICE.Controllers
{
    ...
    public class PriceLocationController : BaseController<PriceLocation, PriceLocationDTO>
    {
        public PriceLocationController(IGenericCQRS<PriceLocation, PriceLocationDTO> service) : base(service)
        {
        }
    }
}
