...
namespace HMS.API_CRM.Controllers.Survey
{
    ...
    public class SurveyThemeController : BaseController<SurveyTheme, SurveyThemeDTO>
    {
        public SurveyThemeController(IGenericCQRS<SurveyTheme, SurveyThemeDTO> service) : base(service)
        {
        }
    }
}
