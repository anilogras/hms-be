...
namespace HMS.API_CRM.Controllers.Survey
{
    ...
    public class QuestionSectionController : BaseController<QuestionSection, QuestionSectionDTO>
    {
        public QuestionSectionController(IGenericCQRS<QuestionSection, QuestionSectionDTO> service) : base(service)
        {
        }
    }
}
