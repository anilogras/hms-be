...
namespace HMS.API_CRM.Controllers.Trace
{
    ...
    public class TaskCategoryController : BaseController<TaskCategory, TaskCategoryDTO>
    {
        public TaskCategoryController(IGenericCQRS<TaskCategory, TaskCategoryDTO> service) : base(service)
        {
        }
    }
}
