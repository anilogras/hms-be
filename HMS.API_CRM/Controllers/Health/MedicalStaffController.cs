...
namespace HMS.API_CRM.Controllers.Health
{
    ...
    public class MedicalStaffController : BaseController<MedicalStaff, MedicalStaffDTO>
    {
        public MedicalStaffController(IGenericCQRS<MedicalStaff, MedicalStaffDTO> service) : base(service)
        {
        }
    }
}
