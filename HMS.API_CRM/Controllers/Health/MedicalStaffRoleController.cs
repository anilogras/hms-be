...
namespace HMS.API_CRM.Controllers.Health
{
    ...
    public class MedicalStaffRoleController : BaseController<MedicalStaffRole, MedicalStaffRoleDTO>
    {
        public MedicalStaffRoleController(IGenericCQRS<MedicalStaffRole, MedicalStaffRoleDTO> service) : base(service)
        {
        }
    }
}
