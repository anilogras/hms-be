...
namespace HMS.API_CRM.Controllers.Health
{
    ...
    public class MedicalActionTypeController : BaseController<MedicalActionType, MedicalActionTypeDTO>
    {
        public MedicalActionTypeController(IGenericCQRS<MedicalActionType, MedicalActionTypeDTO> service) : base(service)
        {
        }
    }
}
